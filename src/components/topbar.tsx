...
export default function Topbar() {
  ...
  return (
    <header className="h-14 bg-[#0d0d0d]/80 backdrop-blur-sm border-b border-[var(--color-border)] flex items-center justify-between gap-3 px-4 lg:px-6 sticky top-0 z-30">
